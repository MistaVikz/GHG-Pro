...
if __name__ == "__main__":
    try:
        # Get num_projects from command line, default to 100
        if len(sys.argv) > 1:
        ...
        'risk_bucket_1_weight_1', 'risk_bucket_1_weight_2', 'risk_bucket_1_weight_3', 'risk_bucket_1_weight_4', 'risk_bucket_1_weight_5',
        'risk_bucket_2_factor_1', 'risk_bucket_2_factor_2', 'risk_bucket_2_factor_3', 'risk_bucket_2_factor_4', 'risk_bucket_2_factor_5',
        'risk_bucket_2_weight_1', 'risk_bucket_2_weight_2', 'risk_bucket_2_weight_3', 'risk_bucket_2_weight_4', 'risk_bucket_2_weight_5',
        'risk_bucket_3_factor_1', 'risk_bucket_3_factor_2', 'risk_bucket_3_factor_3', 'risk_bucket_3_factor_4', 'risk_bucket_3_factor_5',
        'risk_bucket_3_weight_1', 'risk_bucket_3_weight_2', 'risk_bucket_3_weight_3', 'risk_bucket_3_weight_4', 'risk_bucket_3_weight_5',
        'risk_bucket_4_factor_1', 'risk_bucket_4_factor_2', 'risk_bucket_4_factor_3', 'risk_bucket_4_factor_4', 'risk_bucket_4_factor_5',
        'risk_bucket_4_weight_1', 'risk_bucket_4_weight_2', 'risk_bucket_4_weight_3', 'risk_bucket_4_weight_4', 'risk_bucket_4_weight_5',
        'risk_bucket_5_factor_1', 'risk_bucket_5_factor_2', 'risk_bucket_5_factor_3', 'risk_bucket_5_factor_4', 'risk_bucket_5_factor_5',
        'risk_bucket_5_weight_1', 'risk_bucket_5_weight_2', 'risk_bucket_5_weight_3', 'risk_bucket_5_weight_4', 'risk_bucket_5_weight_5'
        ]
        ...
        print(f"Generated {num_projects} projects and saved to GHG_Data.xlsx")
